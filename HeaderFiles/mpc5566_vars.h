/**************************************************************************
 * FILE NAME: $RCSfile: mpc5566_vars.h,v $   COPYRIGHT (c) Freescale 2006 *
 * DESCRIPTION:                                     All Rights Reserved   *
 * Variables that define some features of the MPC5566.                    *
 * !!!!This file must only be included once in every project!!!!          *
 *========================================================================*
 * ORIGINAL AUTHOR: S. Mathieson                                          *
 * $Log: mpc5566_vars.h,v $
 * Revision 1.1  2006/07/12 12:39:12  r54088
 * Initial version.
 *
 *
 **************************************************************************/
...
uint32_t fs_etpu_data_ram_end =   0xC3FC8FFC;
