/**************************************************************************/
/* FILE NAME: mpc5561.h                      COPYRIGHT (c) Freescale 2007 */
...
/* ---   -----------  ---------    ---------------------                  */
/* 1.1   S. Mathieson   13/Oct/06    Initial version.                     */
/*                                                                        */
/* 1.2   G. Emerson   26/Oct/07    All module instantiations now volatile */
...
/**************************************************************************/
/*                    MODULE : PDI(M) Parallel Digital Interface Module   */
/**************************************************************************/
    struct PDIM_tag {
        union {
            vuint32_t R;
            struct {
                ...
                vuint32_t FIFORST:1;
                  vuint32_t:10;
                vuint32_t FIFOTRIGGER:5;
            } B;
        } MCR;                  /* PDIM Module Configuration Register */
        ...
        } ADCCR;                /* PDIM ADC Configuration Register */
        ...
        } INTER;                /* PDIM Interrupt Enable Register */

        union {
            vuint32_t R;
            struct {
                vuint32_t:4;
                vuint32_t ACT_FRM_ORG_X:12;
                  vuint32_t:4;
                vuint32_t ACT_FRM_ORG_Y:12;
            } B;
        } AFOR;                 /* PDIM Active Frame Origin Register */
        ...
        union {
            ...
            struct {
                ...
                vuint32_t ACT_FRM_HEIGHT:12;
                  vuint32_t:4;
                vuint32_t ACT_FRM_WIDTH:12;
            } B;
        } AFSR;                 /* PDIM Active Frame Size Register */
...
/****************************************************************************/
    struct XBAR_tag {
        ...
        } SGPCR5;               /* General Purpose Control Register for Slave Port 5 */

        uint32_t xbar_reserved6a[59];
...
#define PDIM    (*( volatile struct PDIM_tag *)	0xFFFE8000)
